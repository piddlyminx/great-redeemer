"""Backfill source_created_at and add code/date uniqueness

Revision ID: 20251009_000001
Revises: 20251008_000001
...
def upgrade() -> None:
    conn = op.get_bind()
    if not _has_column(conn, "gift_codes", "source_created_at"):
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("gift_codes") as batch_op:
        ...
        if _has_column(conn, "gift_codes", "source_created_at"):
